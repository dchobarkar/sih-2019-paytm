...
data_table = pd.read_csv('recommendations.csv', usecols=[
                         'product_1_id', 'product_2_id', 'factor'])
...
df = pd.read_csv('time_data.csv', usecols=[
                 'day_type',	'send_time',	'response_time', 'action',	'no_of_noti'])
